...
lr_Dis = 0.00005  # Начальная скорость обучения дискриминатора
...
generator_path = 'model/ver-3/generator_epoch_220.pth'
discriminator_path = 'model/ver-3/discriminator_epoch_220.pth'
